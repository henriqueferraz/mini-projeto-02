# IA PARA DESENVOLVEDORES \[T1\]

## Situação de Aprendizagem (Mini-Projeto Avaliativo) \- Módulo 2 \- Semana 05/06

**SUMÁRIO**

**[1\. CONTEXTUALIZAÇÃO	1](#1.-contextualização)**

[**2\. DESAFIO	2**](#2.-desafio)

[**3\. RESULTADOS ESPERADOS (ENTREGA)	2**](#3.-resultados-esperados-\(entrega\))

[**4\. REQUISITOS DA APLICAÇÃO**](#4.-requisitos-da-aplicação)	**3**

[**5\. ROTEIRO DA APLICAÇÃO**](#5.-roteiro-da-aplicação)	**3**

[**5.1. FORMAÇÃO DOS GRUPOS E IDEIA INICIAL**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.hmbdpglz1sdl)	**4**

[**5.2. DEFINIÇÃO DO AGENTE**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.dux2t1hv3t02)	**4**

[**5.3. IMPLEMENTAÇÃO COM LANGGRAPH, FERRAMENTA E CONTEXTO**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.9mok1rqdxyz)	**4**

[**5.4. DOCUMENTAÇÃO, PROMPTS E REPOSITÓRIO**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.jlr0t6ir8et)	**5**

[**6\. CRITÉRIOS DE AVALIAÇÃO**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.fj25mjib2eyh)	**6**

[**7\. CHECKLIST FINAL DE ENTREGA**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.13ps32xs774c)	**8**
...
**7\.** [**CHECKLIST FINAL DE ENTREGA**](https://docs.google.com/document/d/1YYerrQDGE0Iy31PTC_qIV3S60mVRwPgBaJMmXAKEoNc/preview?tab=t.0#heading=h.13ps32xs774c)
